 ...
 */
final class Version20251112123829 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE avatar (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, couleur_peau VARCHAR(255) NOT NULL, couleur_cheveux VARCHAR(255) NOT NULL, style_vestimentaire VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_1677722FFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE evenement (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, consequence_type VARCHAR(50) DEFAULT NULL, semaine_applicable INT DEFAULT NULL, type VARCHAR(20) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE profil (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, score INT DEFAULT NULL, field VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_E6D6B297FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE situation (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, nb_enfants INT NOT NULL, revenu_mensuel INT NOT NULL, logement VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_EC2D9ACAFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tableau_de_bord (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, classement JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', meilleur_score INT DEFAULT NULL, enregistre_score TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_38B30D8AFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE tableau_de_bord ADD CONSTRAINT FK_38B30D8AFB88E14F FOREIGN KEY (utilisateur_id) REFERENCES utilisateur (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tableau_de_bord DROP FOREIGN KEY FK_38B30D8AFB88E14F');
