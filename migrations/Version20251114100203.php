 ...
 */
final class Version20251114100203 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `option` (id INT AUTO_INCREMENT NOT NULL, evenement_id INT NOT NULL, libelle VARCHAR(255) NOT NULL, delta_budget NUMERIC(10, 2) NOT NULL, delta_bien_etre INT NOT NULL, delta_bonheur INT NOT NULL, cout INT DEFAULT 0 NOT NULL, impact_bien_etre_maman INT DEFAULT 0 NOT NULL, impact_bien_etre_enfant INT DEFAULT 0 NOT NULL, INDEX IDX_5A8600B0FD02F13 (evenement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tableau_de_bord (id INT AUTO_INCREMENT NOT NULL, profil_id INT DEFAULT NULL, classement JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', meilleur_score INT DEFAULT NULL, enregistre_score TINYINT(1) NOT NULL, INDEX IDX_38B30D8A275ED078 (profil_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, mot_de_passe VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_1D1C63B3E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
